    ...
    public static function collections() {
        return array(
            'handy-customizer' => array(
                ...
                'website'     => '',
                'download'    => '',
                'name'        => 'Handy Customizer Framework',
            ...
            'handy-add-to-cart' => array(
                ...
                'description' => 'Handy Add To Cart is a very helpful WooCommerce plugin that enables store owners to create a personalized Add To Cart button that lets customers add product to their cart without having to reload the entire site.',
            ),
            'handy-variation-swatches' => array(
                ...
                'description' => 'Handy Variation Swatches is a very helpful WooCommerce plugin that will let the store owners to replace the default dropdown variation with more detailed and engaging variation (button, color, and image) swatches.',
            ),
            'handy-wishlist' => array(
                ...
                'website'     => '',
                'download'    => '',
                'name'        => 'Handy Wishlist For WooCommerce',
                'description' => 'Handy Wishlist is a very helpful and lightweight WooCommerce plugin that enables customers to bookmark and organize their favorite products that they want to simply buy later or keep a careful check on.',
            ),
            ...
            'handy-compare-products' => array(
                ...
                'description' => 'Handy Compare Products is a very helpful WooCommerce plugin that will help your customers make purchase decisions by providing them with a comparison interface that lets customers visualize the comparison of multiple products.',
            ),
            'handy-sliding-cart' => array(
                ...
                'description' => 'Handy Sliding Cart is a very helpful WooCommerce plugin that enables store owners to design a sidebar cart that will improve the customer’s shopping experience, cart visualization, and boosts sales conversions.',
            ),
            'handy-itemized-product-variation' => array(
                ...
                'description' => 'Handy Itemized Product Variation For WooCommerce will let you change the default select option in selecting variation in to itemized (radio button and dropdown component) in order for the users to select the variation in more detailed and easier experience.',
            ),
            'handy-product-variation-table' => array(
                ...
                'description' => 'Handy Product Variation Table is a very helpful and lightweight WooCommerce plugin that will let you add a list of the product’s variations in the form of table, in order to help customers to view or select the product’s variations.',
            ),
            'handy-added-to-cart-popup-notifier' => array(
                ...
                'description' => 'Handy Added To Cart Popup Notifier is a very helpful WooCommerce plugin that enables store owners to design a modal popup that will inform and suggest products to customers after a product has been successfully added to the cart.',
            ),
