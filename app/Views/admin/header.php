            ...
            <div class="hd-header__col--left">
                    <div class="hd-flex hd-flex-ai-c hd-flex-jc-sb hd-gap-10">
                        ...
                        <div class="hd-header__title">
                            <span class="hd-fs-18 hd-fw-700">
                                <?php echo __( 'Quick View', 'handy-quick-view' ); ?>
                            </span>
                ...
                <div class="hd-header__col--right">
                    <div class="hd-flex hd-gap-10">
                        <div>
                            <a class="hd-btn-icon hd-btn-icon--circle" href="https://www.gethandytools.site/plugin/handy-quick-view-for-woocommerce/" title="<?php echo __( 'Help', 'handy-quick-view' ); ?>">
                                <?php echo Helper::get_icon( 'help', 'hd-svg' ); ?>
                            </a>
                        </div>
                        <div class="hd-ps-relative">
                            <button type="button" id="hd-navigation-btn" class="hd-btn-icon hd-btn-icon--circle" data-state="default" title="<?php echo __( 'Open Navigation', 'handy-quick-view' ); ?>">
                                <?php
                                ...
                                <?php
                                    echo Component::get_navigation(array(
                                        array(
                                            'slug'  => 'setting',
                                            'icon'  => 'setting',
                                            'label' => __( 'Setting', 'handy-quick-view' ),
                                        ),
                                        array(
                                            'slug'  => 'import-export',
                                            'icon'  => 'download',
                                            'label' => __( 'Import & Export', 'handy-quick-view' ),
                                        ),
                                    ))
                                ?>
                            </div>
