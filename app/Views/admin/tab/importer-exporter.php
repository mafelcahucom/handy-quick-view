...
<div class="hd-card hd-mb-30" data-state="opened">
    <div class="hd-card__header" data-type="collapsible">
        <span class="hd-card__title">
            <?php echo __( 'Import / Restore Settings', 'handy-quick-view' ); ?>
        </span>
            ...
            <div class="hd-row hd-row--block">
                <div class="hd-row__content hd-row__content--single">
                    <div class="hd-row__field">
                        <p class="hd-mb-10">
                            <?php echo __( 'Imported settings will overwrite existing settings. Note <b>.txt</b> file type are only allowed.', 'handy-quick-view' ); ?>
                        </p>
                        <label class="hd-file-field">
                            ...
                            <span class="hd-file-field__label">
                                <?php echo __( 'Choose a file', 'handy-quick-view' ); ?>
                            </span>
                        ...
                        <?php
                            echo Component::get_button(array(
                                ...
                                'icon'  => 'download',
                                'state' => 'disabled',
                                'label' => __( 'Import Settings', 'handy-quick-view' ),
                            ));
                        ?>
                    </div>
                </div>
...
<div class="hd-card hd-mb-30" data-state="opened">
    <div class="hd-card__header" data-type="collapsible">
        <span class="hd-card__title">
            <?php echo __( 'Export / Duplicate Settings', 'handy-quick-view' ); ?>
        </span>
        <div class="hd-card__chevron">
            <?php echo Helper::get_icon( 'chevron-up', 'hd-svg' ); ?>
        </div>
        ...
        <div class="hd-card__content">
            <div class="hd-row hd-row--block">
                <div class="hd-row__content hd-row__content--single">
                    <div class="hd-row__field">
                        <p class="hd-mb-10">
                            <?php echo __( 'Download a copy of the settings configuration. Note in order to avoid the corruption of the settings configuration <b>.txt</b> file, do not edit it.', 'handy-quick-view' ); ?>
                        </p>
                            ...
                            <div class="hd-export-field__row--1">
                                <label class="hd-checkbox-field" data-state="default">
                                    ...
                                    <span class="hd-checkbox-field__label">
                                        <?php echo __( 'Export All', 'handy-quick-view' ); ?>
                                    </span>
                                </label>
                            </div>
                    ...
                    <div class="hd-row__field">
                        <?php
                            echo Component::get_button(array(
                                ...
                                'icon'  => 'upload',
                                'state' => 'disabled',
                                'label' => __( 'Export Settings', 'handy-quick-view' ),
                            ));
                        ?>
                    </div>
                </div>
