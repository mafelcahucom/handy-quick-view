            ...
            <div class="hd-home__banner">
                <div class="hd-txt-center">
                    <h1 class="hd-home__title">
                        <?php echo __( 'Handy Tools', HQFW_PLUGIN_DOMAIN ); ?>
                    </h1>
                    <p class="hd-fs-16">
                        <?php echo __( 'Build an amazing WordPress website faster with our handy tools.', HQFW_PLUGIN_DOMAIN ); ?>
                    </p>
                </div>
            </div>
                    ...
                    <div class="hd-home__plugin">
                        ...
                        <div class="hd-home__plugin__footer">
                            <div class="hd-home__plugin__control">
                                <div class="hd-col-left">
                                    <p class="hd-fw-600">
                                        <?php echo __( 'Status: ', HQFW_PLUGIN_DOMAIN ); ?>
                                        <span class="hd-clr-black-4">
                                            <?php
                                                if ( Plugins::is_installed( $plugin['slug'] ) ) {
                                                    echo __( 'Installed', HQFW_PLUGIN_DOMAIN );
                                                } else {
                                                    echo __( 'Not Installed', HQFW_PLUGIN_DOMAIN );
                                                }
                                            ?>
                                        </span>
                                    </p>
