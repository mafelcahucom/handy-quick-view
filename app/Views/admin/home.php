            ...
            <div class="hd-home__banner">
                <div class="hd-txt-center">
                    <p class="hd-home__developer">
                        <span><?php echo __( 'HANDCRAFTED BY ', 'handy-quick-view' ); ?></span>
                    ...
                    <h1 class="hd-home__title">
                        <?php echo __( 'Handy Tools', 'handy-quick-view' ); ?>
                    </h1>
                    <p class="hd-home__description">
                        <?php echo __( 'Handy Tools offers a suite of free, easy-to-use WordPress plugins crafted to streamline the development and management of your WooCommerce stores.', 'handy-quick-view' ); ?>
                    </p>
                </div>
            </div>
                    ...
                    <div class="hd-home-plugin">
                                    ...
                                    <div class="hd-home-col__right">
                                        ...
                                        <?php if ( Plugins::is_installed( $plugin['slug'] ) ) : ?>
                                            <p class="hd-home-plugin__status" data-state="installed">
                                                ...
                                                <?php echo __( 'Installed', 'handy-quick-view' ); ?>
                                            </p>
                                        <?php else : ?>
                                            <p class="hd-home-plugin__status" data-state="not-installed">
                                                ...
                                                <?php echo __( 'Not Installed', 'handy-quick-view' ); ?>
                                            </p>
                                        <?php endif; ?>
                                    </div>
                                </div>
                        ...
                        <div class="hd-home-plugin__footer">
                            <div class="hd-home-plugin__tools">
                                <a class="hd-home-plugin__tool" href="https://wordpress.org/download/" target="_blank" aria-label="<?php echo __( 'WordPress', 'handy-quick-view' ); ?>" title="<?php echo __( 'WordPress', 'handy-quick-view' ); ?>">
                                    ...
                                    <span>
                                        <?php echo __( '4.8.14+', 'handy-quick-view' ); ?>
                                    </span>
                                </a>
                                <a class="hd-home-plugin__tool" href="https://woocommerce.com/" target="_blank" aria-label="<?php echo __( 'WooCommerce', 'handy-quick-view' ); ?>" title="<?php echo __( 'WooCommerce', 'handy-quick-view' ); ?>">
                                    ...
                                    <span>
                                        <?php echo __( '4.0.0+', 'handy-quick-view' ); ?>
                                    </span>
                                </a>
                                <a class="hd-home-plugin__tool" href="https://www.php.net/" target="_blank" aria-label="<?php echo __( 'PHP', 'handy-quick-view' ); ?>" title="<?php echo __( 'PHP', 'handy-quick-view' ); ?>">
                                    ...
                                    <span>
                                        <?php echo __( '7.4.8+', 'handy-quick-view' ); ?>
                                    </span>
                                </a>
                            </div>
