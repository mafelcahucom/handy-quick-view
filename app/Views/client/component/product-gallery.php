<?php
/**
 * App > Views > Client > Component > Product Gallery.
 *
 * @since   1.0.0
 *
 * @version 1.0.0
...
<div id="hqfw-js-photo-slider" class="hqfw-photo-slider" data-current-slide="0">
    ...
    <div class="hqfw-photo-slider__container">
        <?php foreach ( $args['images'] as $key => $value ) : ?>
            <?php
				...
				$value['image'] = array( $value['image'], 480, 480 );
                }
    ...
    <?php if ( $settings['gn_pt_enable_slider'] && $total_images > 1 ) : ?>
        <button class="hqfw-js-photo-slider-controller hqfw-photo-slider__controller hqfw-flex-c hqfw-hover" data-event="prev" title="<?php echo __( 'Previous', 'handy-quick-view' ); ?>" aria-label="<?php echo __( 'Previous', 'handy-quick-view' ); ?>">
            <?php
        ...
        <button class="hqfw-js-photo-slider-controller hqfw-photo-slider__controller hqfw-flex-c hqfw-hover" data-event="next" title="<?php echo __( 'Next', 'handy-quick-view' ); ?>" aria-label="<?php echo __( 'Next', 'handy-quick-view' ); ?>">
            <?php
