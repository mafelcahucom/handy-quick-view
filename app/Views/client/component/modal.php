	...
	<div class="hqfw-js-close-modal hqfw-modal__overlay hqfw-flex hqfw-flex-ai-c">
		<div class="hqfw-js-close-modal hqfw-viewer hqfw-flex hqfw-flex-ai-c">
			<div class="hqfw-viewer__navigation">
				<button type="button" class="hqfw-js-navigation-btn hqfw-navigation-btn hqfw-flex-c hqfw-hover" data-product_id="0" data-event="prev" data-state="disabled" aria-label="Previous" title="Previous">
			...
			<div class="hqfw-viewer__navigation">
				<button type="button" class="hqfw-js-navigation-btn hqfw-navigation-btn hqfw-flex-c hqfw-hover" data-product_id="0" data-event="next" data-state="disabled" aria-label="Next" title="Next">
