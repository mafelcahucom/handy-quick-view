<?php
/**
 * App > Views > Client > Component > Modal.
 *
 * @since   1.0.0
 *
 * @version 1.0.0
		...
		<div class="hqfw-js-close-modal hqfw-viewer hqfw-flex hqfw-flex-ai-c">
			<?php if ( $settings['gn_md_enable_slider'] ) : ?>
				<div class="hqfw-viewer__navigation">
					<button type="button" class="hqfw-js-navigation-btn hqfw-navigation-btn hqfw-flex-c hqfw-hover" data-product_id="0" data-event="prev" data-state="disabled" title="<?php echo __( 'Previous', 'handy-quick-view' ); ?>" aria-label="<?php echo __( 'Previous', 'handy-quick-view' ); ?>">
						<?php
			...
			<?php if ( $settings['gn_md_enable_slider'] ) : ?>
				<div class="hqfw-viewer__navigation">
					<button type="button" class="hqfw-js-navigation-btn hqfw-navigation-btn hqfw-flex-c hqfw-hover" data-product_id="0" data-event="next" data-state="disabled" title="<?php echo __( 'Next', 'handy-quick-view' ); ?>" aria-label="<?php echo __( 'Next', 'handy-quick-view' ); ?>">
						<?php
