...
final class ImporterExporterEvent {
    ...
    protected function __construct() {
        // Export Setting.
        add_action( 'wp_ajax_hqfw_export_settings', [ $this, 'export_settings' ] );

        // Import Setting.
        add_action( 'wp_ajax_hqfw_import_settings', [ $this, 'import_settings' ] );
    }
    ...
    public function import_settings() {
        ...
        update_option( '_hqfw_main_settings', $decoded_settings );
        wp_send_json_success([
