...
use HQFW\Admin\Inc\FieldValidation;
...
final class Events {
    ...
    protected function __construct() {
         ...
         * Export Setting.
         */
        add_action( 'wp_ajax_hqfw_export_settings', array( $this, 'export_settings' ) );

        /**
         * Import Setting.
         */
        add_action( 'wp_ajax_hqfw_import_settings', array( $this, 'import_settings' ) );
    }
    ...
    public function import_settings() {
        ...
        if ( $decrypted_settings === false ) {
            wp_send_json_error(array(
                ...
                'detail' => __( 'Failed to decrypt settings.', 'handy-quick-view' ),
            ));
        }
        ...
        if ( count( $validation['validation']['invalid'] ) > 0 ) {
            wp_send_json_error(array(
                'error'  => 'CORRUPTED_SETTING_FILE',
                'detail' => __( 'Settings failed in validation.', 'handy-quick-view' ),
            ));
        }
        ...
        update_option( '_hqfw_main_settings', $merged_settings );
        wp_send_json_success(array(
