...
final class Admin {
    ...
    public function register_menu_styles() {
        ...
        $asset        = include HQFW_PLUGIN_PATH . 'public/admin/styles/hqfw-home.asset.php';
        $asset['src'] = Helper::get_public_src( 'styles/hqfw-home.css' );
        wp_register_style( 'hqfw-home', Helper::get_public_src( 'styles/hqfw-home.css' ), $asset['dependencies'], $asset['version'], 'all' );
    ...
    public function register_submenu_styles() {
        ...
        $asset        = include HQFW_PLUGIN_PATH . 'public/admin/styles/hqfw-admin.asset.php';
        $asset['src'] = Helper::get_public_src( 'styles/hqfw-admin.css' );
        wp_register_style( 'hqfw-admin', $asset['src'], $asset['dependencies'], $asset['version'], 'all' );
    ...
    public function register_submenu_scripts() {
        ...
        $asset        = include HQFW_PLUGIN_PATH . 'public/admin/scripts/hqfw-admin.asset.php';
        $asset['src'] = Helper::get_public_src( 'scripts/hqfw-admin.js' );
        wp_register_script( 'hqfw-admin', $asset['src'], $asset['dependencies'], $asset['version'], true );
        wp_enqueue_script( 'hqfw-admin' );

        wp_localize_script( 'hqfw-admin', 'hqfwLocal', array(
