...
final class FieldValidation {
    ...
    public static function validate_text_field( $args = array() ) {
        ...
        if ( strlen( $args['value'] ) <= $args['max'] ) {
            ...
            $output['error'] = sprintf(
                __( 'Total characters must not exceed in %s.', 'handy-quick-view' ),
                $args['max']
            );
        }
    ...
    public static function validate_number_field( $args = array() ) {
        ...
        if ( $args['value'] !== '' && $args['value'] !== null ) {
            ...
            if ( is_numeric( $number ) ) {
                ...
                $output['error'] = __( 'Invalid value. Please enter the appropriate value.', 'handy-quick-view' );
            }
        }
    ...
    public static function validate_switch_field( $args = array() ) {
        $output = array(
            'success' => false,
            'value'   => $args['current_value'],
            'error'   => __( 'Invalid value. Please enter the appropriate value.', 'handy-quick-view' ),
        );
    ...
    public static function validate_select_field( $args = array() ) {
        $output = array(
            'success' => false,
            'value'   => $args['current_value'],
            'error'   => __( 'This field is required.', 'handy-quick-view' ),
        );
    ...
    public static function validate_icon_picker_field( $args = array() ) {
        ...
        if ( ! empty( $args['value'] ) ) {
            ...
            if ( in_array( $args['value'], $args['icons'] ) ) {
                ...
                $output['error'] = __( 'Invalid icon. Please select the appropriate icon.', 'handy-quick-view' );
            }
        }
    ...
    public static function validate_image_picker_field( $args = array() ) {
        ...
        if ( ! empty( $args['value'] ) ) {
            ...
            if ( in_array( $args['value'], $args['choices'] ) ) {
                ...
                $output['error'] = __( 'Invalid image. Please select the appropriate image.', 'handy-quick-view' );
            }
        }
    ...
    public static function validate_loader_picker_field( $args = array() ) {
        ...
        if ( ! empty( $args['value'] ) ) {
            ...
            if ( in_array( $args['value'], $args['choices'] ) ) {
                ...
                $output['error'] = __( 'Invalid loader. Please select the appropriate loader.', 'handy-quick-view' );
            }
        }
    ...
    public static function validate_color_picker_field( $args = array() ) {
        ...
        if ( ! empty( $args['value'] ) ) {
            if ( preg_match( '/^rgba\((\d{1,3}),\s*(\d{1,3}),\s*(\d{1,3}),\s*(\d*(?:\.\d+)?)\)$/', $args['value'] ) == true ) {
                ...
                $output['error'] = __( 'Invalid color format. Please enter the appropriate color format.', 'handy-quick-view' );
            }
        }
