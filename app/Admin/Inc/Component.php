...
final class Component {
    ...
    public static function get_logo() {
        return sprintf(
            ...
            __( 'Handy Quick View', 'handy-quick-view' ),
            __( 'Handy Quick View', 'handy-quick-view' )
        );
    }
     ...
     * @since 1.0.0
     *
     * @param  array $args Contains the necessary parameters for creating navigation list.
     * $args = [
     ...
     * @since 1.0.0
     *
     * @param  array $args Contains the necessary parameters for creating message component.
     * $args = [
     ...
     * @since 1.0.0
     *
     * @param  array $args Contains all the arguments for creating tab component.
     * $args = [
